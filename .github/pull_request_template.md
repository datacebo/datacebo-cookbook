...
- [ ] An entry was made in the [catalog.yaml](https://github.com/datacebo/datacebo-cookbook/blob/main/registry.yaml) for this notebook. Make sure the following conditions are met:
  ...
  - [ ] Select a topic from TOPIC.json based on the content of the notebook. 
  - [ ] An appropriate tag(s) from TAG.md was added to describe the notebook. 
  - [ ] Select a domain from DOMAIN.md (if applicable).
