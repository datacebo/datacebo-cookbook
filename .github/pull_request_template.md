...
- [ ] An entry was made in the [catalog.yaml](https://github.com/datacebo/datacebo-cookbook/blob/main/registry.yaml) for this notebook. Make sure the following conditions are met:
  ...
  - [ ] A file path was added for the notebook. This should be relative to the `datacebo-cookbook` directory (eg. tutorials/synthesizing/SDV_Synthesize_a_table_(Gaussian_Copula).ipynb)
